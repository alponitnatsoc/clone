    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('name', 'text',  array('label' => false,
                  'attr'=>array('class'=>'campos', 'required'=>'true', 'placeholder'=>'Escribe tu nombre y apellidos')))
            ->add('email', 'text',  array('label' => false,
                  'attr'=>array('class'=>'campos', 'required'=>'true', 'placeholder'=>'Escribe tu dirección de correo')))
            ->add('phone', 'text',  array('label' => false,
                  'attr'=>array('class'=>'campos', 'required'=>'true', 'placeholder'=>'Escribe tu número de celular')))
            ;
    }
